...
\startMPpage[offset=1dk]
  ...
  A[1] := (1,1)--(2,1)--(2,1.5)--(1.5,2)--(1,2) -- cycle;
  A[3] := (3,3)--(2,3)--(2,2.5)--(2.5,2)--(3,2) -- cycle;
...
\startMPpage[offset=1dk]
  ...
  A[2] :=  (2.5, 1.1) .. (2.9, 1.1) -- (2.9, 2.9) -- (1.1, 2.9) ..
           (1.1, 2.5) .. cycle;

  A[2] := A[2] cornered (0.2) randomized 0.03;
