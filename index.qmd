...
course:
  term: "Fall 2026"
  office-hours: "Wednesday 2pm–3pm at MC 533"
  teaching-assistants: "Tao Zhang"
  mid-term: "Oct 16"
  lectures:
    - "11:35am–12:55pm Wednesday and Friday (ENGTR 1080)"
  tutorials:
    - "8:35am–9:25am Friday (ENGMC 12)"
format: 
  html: 
...
| 2    | [Random variables](random-variables.qmd) | 
| 3    | [Random vectors](random-vectors.qmd) | 
| 4    | [Gaussian random vectors](gaussian-random-vectors.qmd); [conditional probability and conditional expectation](conditional-expectation.qmd) |
| 5    | [MMSE estimation](mmse-estimation.qmd) |
| 6    | [Moment generating functions and sums of random variables](moment-generating-functions.qmd); [probability inequalities](inequalities.qmd) |
...
| 9    | [Stochastic processes](stochastic-processes.qmd) and [Markov chains](markov-chains.qmd) |
| 10   | [Hitting times and limiting distributions of Markov chains](markov-chains.qmd) |
| 11   | [Gauss–Markov models and spectral analysis](gauss-markov-processes.qmd) |
| 12   | [Poisson processes](poisson-processes.qmd) |
| 13   | [Continuous-time Markov chains](continuous-time-markov-chains.qmd); [Brownian motion](brownian-motion.qmd) |
...
- **There will be no make-up examination** for students who miss a mid-term.

  - Students who miss the exam due to a valid reason (see [Faculty of Engineering policy][policy]) should **notify the instructor within a week** of the exam and provide **necessary documentation**.
...
- Any request for re-evaluation of a mid-term or an assignment must be made **in writing within a week of its return**. Note that requesting a re-evaluation will mean that your **whole** assignment or exam will be re-evaluated.
...
The course is taught in a “chalk and board” style; there will be no PowerPoint presentations. All students are expected to attend lectures and take notes. Partial notes on some of the material will be provided, but are not a substitute for the material covered in class.
...
[guide]: https://www.mcgill.ca/deanofstudents/student-rights-and-conduct/academic-integrity

[evaluations]: https://www.mcgill.ca/mercury/
