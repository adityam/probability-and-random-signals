...
- The lowest two assignments and labs will be dropped. There will be no make-up for missed assignments, _even if it is for a valid reason._ The whole point of dropping the lowest two assignments is to reduce the administrative overhead of keeping track of such missed assignments.
