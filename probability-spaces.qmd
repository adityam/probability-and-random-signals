...
14. Let $\ALPHABET D_1$ and $\ALPHABET D_2$ be two partitions of $Ω$. We say **$\ALPHABET D_1$ is finer than $\ALPHABET D_2$** if $σ(\ALPHABET D_1) \subseteq σ(\ALPHABET D_2)$. For instance, suppose $Ω = \{1, 2, 3, 4\}$ and 
    $$
