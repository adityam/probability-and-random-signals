...
7. The orthogonal projection is the conditional expectation, i.e.,
   ...
   $$
   Since $X - \hat X$ and $Y$ are jointly Gaussian and uncorrelated (as shown above), they are independent. Therefore, for any (measurable) function $g$, the independence gives:
   $$
