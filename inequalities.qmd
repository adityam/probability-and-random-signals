...
@exm-Markov shows that the Markov inequality is not tight. Moreover, it gives a vacuous bound for $a < μ$. Thus, it only makes sense to apply the Markov inequality when $a \ge μ$.  
...
$$ 
is the [Legendre-Fenchel transform](https://adityam.github.io/stochastic-control/convexity/duality.html) of $\log M_X(s)$.
:::
