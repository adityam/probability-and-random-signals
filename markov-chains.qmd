...
Let $μ^{(n)}$ denote the PMF of the state of the Markov chain at time $n$. We will think of of $μ^{(n)}$ as a row vector. Then, by the law of total probability, we have
$$
