...
8. However, the converse is not true. Convergence in probability does not imply almost sure convergence, as is illustrated by the following example.
...
Note that part (b) converges in mean square but not almost surely.
:::
