...
3. As we pointed out, [conditional probabilities are probabilities](probability-spaces.qmd#conditional-probabilities-are-probabilities), the conditional CDF defined above satisfies the properties of regular CDFs. In particular
