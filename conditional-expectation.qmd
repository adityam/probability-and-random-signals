...
{\EXP[ \EXP[ X \mid \ALPHABET H ] \mid \ALPHABET G ] =
...
$$
\EXP[ \EXP[ X \mid \ALPHABET H] ] =
\EXP[ X ].
$$
where we have taken $\ALPHABET G = \{\emptyset, Ω\}$ as the trivial $σ$-algebra. Observe that the above definition is equivalent to the law of total probability!
